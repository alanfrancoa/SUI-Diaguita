                ...
                <?php foreach ($data['usuarios'] as $usuario) : ?>
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="<?php echo RUTA_URL; ?>/adminController/reactivarUsuario/<?php echo $usuario->nombre_usuario; ?>" class="btn btn-success" onclick="return confirm('¿Estás seguro de reactivar esta comisión?');">Activar</a> 
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php else : ?>
